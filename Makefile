...
results/isles.png: results/isles.dat scripts/plotcount.py
	python scripts/plotcount.py \
    	--input_file=results/isles.dat \
   		--output_file=results/figure/isles.png

results/abyss.png: results/abyss.dat scripts/plotcount.py
	python scripts/plotcount.py \
    	--input_file=results/abyss.dat \
    	--output_file=results/figure/abyss.png

results/last.png: results/last.dat scripts/plotcount.py
	python scripts/plotcount.py \
   		--input_file=results/last.dat \
    	--output_file=results/figure/last.png

results/sierra.png: results/sierra.dat scripts/plotcount.py
	python scripts/plotcount.py \
...
report/count_report.html report/count_report_files: results/isles.png results/abyss.png results/last.png results/sierra.png
